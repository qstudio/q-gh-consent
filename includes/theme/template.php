        ...
        <div class="q-tab-target col-12" data-tab-target="settings"> 
            ...
            <div class="row">
                <div class="col-12 options">
                    <div class="container">
                        <div class="row">
                            <span class="toggle_legend">off / on</span>
                        </div>
                        <div class="row">
                            <div class="description col-8 col-md-10">
                                <h5>Functional Cookies</h5>
                                <div class="q-consent-padding">
                                    <small>These cookies are necessary for our sites to function properly. These cookies secure our forms, support login sessions and remember user dialogue. Because the site does not function without these cookies, opt-out is not available. They are not used for marketing or analytics.</small>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="description col-8 col-md-10">
                                ...
                                <div class="q-consent-padding">
                                    <small>These cookies are used to enhance the relevance of our advertising on social media and to tailor messages relevant to your interests.</small>
                                </div>
                            </div>
                            <div class="col-4 col-md-2">
                                <div class="q-consent-wrapper">
                        ...
                        <div class="row">
                            <div class="description col-8 col-md-10">
                                ...
                                <div class="q-consent-padding">
                                    <small>These cookies collect anonymous data on how visitors use our site and how our pages perform. We use this information to make the best site possible for our users.</small>
                                </div>
                            </div>
                            <div class="col-4 col-md-2">
                                <div class="q-consent-wrapper">
                    ...
                    <div class="col-12 cta float-right">
                        <div class="d-inline-block float-right">
                            <a href="https://greenheartorg.staging.wpengine.com/#/modal/consent/tab/settings/" class="modal-trigger" data-tab-trigger="settings">
                                <button 
                        ...
                        <div class="d-inline-block float-right">
                            <button type="button" class="btn btn-primary reset q-consent-reset">
                                RESET
                            </button>
                        </div>
                    </div>
